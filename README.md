...
<!-- Social Badges -->
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/mihir-sahay-101324279/)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/sahaymihir)
[![LeetCode](https://img.shields.io/badge/LeetCode-FFA116?style=for-the-badge&logo=leetcode&logoColor=black)](https://leetcode.com/mihirsahay)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:mihirsahay0123@gmail.com)
...
const mihir = {
  name        : "Mihir Sahay",
  institution : "MIT Manipal (MAHE) — B.Tech CCE, Class of 2027",
  roles       : [ "Backend Developer", "Open Source Contributor", "Android / AOSP Developer"],
  currentFocus: ["AWS Serverless", "Data Mining & ML", "Competitive Programming"],
  askMeAbout  : ["Custom ROMs", "Android internals", "REST APIs", "System Design"],
};
```
...
## 📱 Open Source — Android Universe

```
🔧 Former Maintainer @ Palladium OS
     └─ Shipped stable Android builds for multiple device trees

📦 Developer @ PixelExp-MOD
     └─ Merged AOSPA + Pixel sources
     └─ Added Pixel-exclusive features & UI/UX enhancements
     └─ Maintained device-specific patches & kernel integrations
